...
The simplest way to install is to click on \'Plugins\' then \'Add\' and type \'Modula Envira Migrator\' in the search field.
...
4. Select the plugin zip file (modula-envira-migrator.x.x.x.zip) from your computer then click the Install Now button.
5. You should see a message stating that the plugin was installed successfully.
6. Click the Activate Plugin link.
= For manual installation 2: =
1. You should have access to the server where WordPress is installed. If you don\'t, see your system administrator.
2. Copy the plugin zip file (modula-envira-migrator.x.x.x.zip) up to your server and unzip it somewhere on the file system.
...
See <a href="https://github.com/WPChill/modula-envira-migrator/blob/main/changelog.txt" target="_blank">changelog</a>
